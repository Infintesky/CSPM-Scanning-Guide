"""
References: https://github.com/RedcentricCyber/scout2csv.git
Usage:
    python scoutsuite_js2csv.py
"""
...
results = list(Path(".").rglob("scoutsuite_results_aws*.js")) # change aws to azure or gcp for other cloud providers
data = []
